...
namespace lisandroct.EventSystem
{
    ...
    public abstract class Detector<T, U> : MonoBehaviour
    {
    ...
    public abstract class Detector<T, U, V> : MonoBehaviour
    {
    ...
    public abstract class Detector<T, U, V, W> : MonoBehaviour
    {
